...
public class Main {
    ...
    static String oracleUserName = "hafoster"; // replace with your uniqname
    static String password = "Kinderring3"; // replace with your Oracle password (default: eecsclass)
